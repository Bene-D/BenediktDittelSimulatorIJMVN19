...
Um das Programm mit benutzerdefinierten Einstellungen zu starten, können der casimulator.properties-Datei folgende Parameter hinzugefügt werden:

language=x
speed=y
- x kann "de" oder "en" sein (ohne " ")
- y kann ein Wert zwischen 200 - 3400 sein
(200=sehr schnell, 1000=schnell, 1800=standard, 2600=langsam, 3400=sehr langsam)